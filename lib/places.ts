...
export const PLACES: Place[] = [
  ...
  { id: "nerimanov_rayon", az: "Nərimanov", ru: "Nərimanov", en: "Nərimanov", lat: 40.406, lng: 49.887, type: "rayon", kind: "area", parentId: "baku" },
  ...
  { id: "20_yanvar_metro", az: "20 Yanvar", ru: "20 Yanvar", en: "20 Yanvar", lat: 40.40414, lng: 49.8077, type: "metro", kind: "metro", parentId: "baku" },
  { id: "28_may_metro", az: "28 May", ru: "28 May", en: "28 May", lat: 40.37986, lng: 49.84864, type: "metro", kind: "metro", parentId: "baku" },
  { id: "8_noyabr_metro", az: "8 Noyabr", ru: "8 Noyabr", en: "8 Noyabr", lat: 40.40187, lng: 49.82051, type: "metro", kind: "metro", parentId: "baku" },
  { id: "avtovagzal_metro", az: "Avtovağzal", ru: "Avtovağzal", en: "Avtovağzal", lat: 40.42151, lng: 49.79522, type: "metro", kind: "metro", parentId: "baku" },
  { id: "azadliq_prospekti_metro", az: "Azadlıq prospekti", ru: "Азадлыг проспекти", en: "Azadlıq prospekti", lat: 40.42596, lng: 49.84293, type: "metro", kind: "metro", parentId: "baku" },
  { id: "bakmil_metro", az: "Bakmil", ru: "Бакмил", en: "Bakmil", lat: 40.41414, lng: 49.8788, type: "metro", kind: "metro", parentId: "baku" },
  { id: "cefer_cabbarli_metro", az: "Cəfər Cabbarlı", ru: "Cəfər Cabbarlı", en: "Cəfər Cabbarlı", lat: 40.37965, lng: 49.84895, type: "metro", kind: "metro", parentId: "baku" },
  { id: "dernegul_metro", az: "Dərnəgül", ru: "Дарнагюль", en: "Dərnəgül", lat: 40.4254, lng: 49.86179, type: "metro", kind: "metro", parentId: "baku" },
  { id: "elmler_akademiyasi_metro", az: "Elmlər Akademiyası", ru: "Элмляр Академиясы", en: "Elmlər Akademiyası", lat: 40.37515, lng: 49.81548, type: "metro", kind: "metro", parentId: "baku" },
  { id: "ehmedli_metro", az: "Əhmədli", ru: "Ахмедлы", en: "Əhmədli", lat: 40.38556, lng: 49.95395, type: "metro", kind: "metro", parentId: "baku" },
  { id: "genclik_metro", az: "Gənclik", ru: "Gənclik", en: "Gənclik", lat: 40.39988, lng: 49.85096, type: "metro", kind: "metro", parentId: "baku" },
  { id: "hezi_aslanov_metro", az: "Həzi Aslanov", ru: "Ази Асланов", en: "Həzi Aslanov", lat: 40.37304, lng: 49.95357, type: "metro", kind: "metro", parentId: "baku" },
  ...
  { id: "insaatcilar_metro", az: "İnşaatçılar", ru: "Иншаатчылар", en: "İnşaatçılar", lat: 40.38909, lng: 49.80236, type: "metro", kind: "metro", parentId: "baku" },
  ...
  { id: "mehemmed_hadi_metro", az: "Məhəmməd Hadi", ru: "Məhəmməd Hadi", en: "Məhəmməd Hadi", lat: 40.37242, lng: 49.95207, type: "metro", kind: "metro", parentId: "baku" },
  { id: "neftciler_metro", az: "Neftçilər", ru: "Нефтчиляр", en: "Neftçilər", lat: 40.41116, lng: 49.94257, type: "metro", kind: "metro", parentId: "baku" },
  { id: "neriman_nerimanov_metro", az: "Nəriman Nərimanov", ru: "Нариман Нариманов", en: "Nəriman Nərimanov", lat: 40.40282, lng: 49.87064, type: "metro", kind: "metro", parentId: "baku" },
  ...
  { id: "sahil_metro", az: "Sahil", ru: "Sahil", en: "Sahil", lat: 40.37173, lng: 49.84457, type: "metro", kind: "metro", parentId: "baku" },
  { id: "ulduz_metro", az: "Ulduz", ru: "Улдуз", en: "Ulduz", lat: 40.41496, lng: 49.89143, type: "metro", kind: "metro", parentId: "baku" },
  { id: "xalqlar_dostlugu_metro", az: "Xalqlar Dostluğu", ru: "Халглар Достлугу", en: "Xalqlar Dostluğu", lat: 40.39689, lng: 49.95299, type: "metro", kind: "metro", parentId: "baku" },
  { id: "4_cu_mikrorayon_mr", az: "4-cü Mikrorayon", ru: "4-й микрорайон", en: "4-cü Mikrorayon", lat: 40.41648, lng: 49.81157, type: "microrayon", kind: "area", parentId: "baku" },
  ...
  { id: "bibiheybet_mr", az: "Bibiheybət", ru: "Bibiheybət", en: "Bibiheybət", lat: 40.30627, lng: 49.82236, type: "microrayon", kind: "area", parentId: "baku" },
  { id: "bileceri_mr", az: "Biləcəri", ru: "Баладжары", en: "Baladjary", lat: 40.44148, lng: 49.80955, type: "microrayon", kind: "area", parentId: "baku" },
  { id: "dernegul_mr", az: "Dərnəgül", ru: "Дарнагюль", en: "Dərnəgül", lat: 40.41873, lng: 49.84979, type: "microrayon", kind: "area", parentId: "baku" },
  ...
  { id: "resulzade_mr", az: "Rəsulzadə", ru: "Расулзаде", en: "Rəsulzadə", lat: 40.43108, lng: 49.83625, type: "microrayon", kind: "area", parentId: "baku" },
  { id: "subani_mr", az: "Şubanı", ru: "Şubanı", en: "Şubanı", lat: 40.36324, lng: 49.76372, type: "microrayon", kind: "area", parentId: "baku" },
  ...
  { id: "zig_mr", az: "Zığ", ru: "Zığ", en: "Zığ", lat: 40.34275, lng: 49.98038, type: "microrayon", kind: "area", parentId: "baku" },
  { id: "28_may_q", az: "28 May", ru: "28 May", en: "28 May", lat: 40.46154, lng: 49.63905, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "bahar_q", az: "Bahar", ru: "Bahar", en: "Bahar", lat: 40.36786, lng: 50.02964, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "balaxani_q", az: "Balaxanı", ru: "Балаханы", en: "Balaxanı", lat: 40.4616, lng: 49.92142, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "bilgeh_q", az: "Bilgəh", ru: "Бильгях", en: "Bilgəh", lat: 40.57416, lng: 50.04093, type: "qesebe", kind: "area", parentId: "baku" },
  ...
  { id: "bulbule_q", az: "Bülbülə", ru: "Бюльбюля", en: "Bülbülə", lat: 40.43254, lng: 49.97815, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "buzovna_q", az: "Buzovna", ru: "Бузовна", en: "Buzovna", lat: 40.52224, lng: 50.10291, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "cicek_q", az: "Çiçək", ru: "Çiçək", en: "Çiçək", lat: 40.43888, lng: 49.74993, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "dede_qorqud_q", az: "Dədə Qorqud", ru: "Деде Коркуд", en: "Dədə Qorqud", lat: 40.38682, lng: 50.0243, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "dubendi_q", az: "Dübəndi", ru: "Dübəndi", en: "Dübəndi", lat: 40.41563, lng: 50.29966, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "ehmedli_q", az: "Əhmədli", ru: "Ахмедли", en: "Ahmedli", lat: 40.38513, lng: 49.94471, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "emircan_q", az: "Əmircan", ru: "Əmircan", en: "Əmircan", lat: 40.42198, lng: 49.99007, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "gurgan_q", az: "Gürgan", ru: "Gürgan", en: "Gürgan", lat: 40.39689, lng: 50.33447, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "hovsan_q", az: "Hövsan", ru: "Hövsan", en: "Hövsan", lat: 40.36687, lng: 50.08086, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "kurdexani_q", az: "Kürdəxanı", ru: "Kürdəxanı", en: "Kürdəxanı", lat: 40.5508, lng: 49.91722, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "lokbatan_q", az: "Lökbatan", ru: "Локбатан", en: "Lökbatan", lat: 40.32527, lng: 49.73083, type: "qesebe", kind: "area", parentId: "baku" },
  ...
  { id: "musfiqabad_q", az: "Müşfiqabad", ru: "Мушфигабад", en: "Müşfiqabad", lat: 40.46875, lng: 49.62179, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "nardaran_q", az: "Nardaran", ru: "Нардаран", en: "Nardaran", lat: 40.55888, lng: 50.00653, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "pirallahi_q", az: "Pirallahı", ru: "Пираллахы", en: "Pirallahı", lat: 40.45918, lng: 50.33399, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "pirsagi_q", az: "Pirşağı", ru: "Пиршаги", en: "Pirşağı", lat: 40.55877, lng: 49.88734, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "puta_q", az: "Puta", ru: "Пута", en: "Puta", lat: 40.29657, lng: 49.66132, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "qala_q", az: "Qala", ru: "Qala", en: "Qala", lat: 40.44413, lng: 50.16317, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "qizildas_q", az: "Qızıldaş", ru: "Кызылдаш", en: "Qızıldaş", lat: 40.30802, lng: 49.59785, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "ramana_q", az: "Ramana", ru: "Ramana", en: "Ramana", lat: 40.45717, lng: 49.98261, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "sabuncu_q", az: "Sabunçu", ru: "Сабунчи", en: "Sabunçu", lat: 40.44814, lng: 49.93389, type: "qesebe", kind: "area", parentId: "baku" },
  ...
  { id: "suraxani_q", az: "Suraxanı", ru: "Сураханы", en: "Suraxanı", lat: 40.42003, lng: 50.00189, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "suvelan_q", az: "Şüvəlan", ru: "Шувелан", en: "Şüvəlan", lat: 40.48674, lng: 50.18397, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "turkan_q", az: "Türkan", ru: "Тюркан", en: "Türkan", lat: 40.36628, lng: 50.21312, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "yeni_balaxani_q", az: "Yeni Balaxanı", ru: "Yeni Balaxanı", en: "Yeni Balaxanı", lat: 40.47496, lng: 49.91567, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "yeni_kurdexani_q", az: "Yeni Kürdəxanı", ru: "Yeni Kürdəxanı", en: "Yeni Kürdəxanı", lat: 40.51087, lng: 49.94004, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "yeni_ramana_sabuncu_q", az: "Yeni Ramana Sabunçu", ru: "Раманы", en: "Yeni Ramana Sabunçu", lat: 40.44228, lng: 49.97846, type: "qesebe", kind: "area", parentId: "baku" },
  ...
  { id: "yeni_turkan_q", az: "Yeni Türkan", ru: "Yeni Türkan", en: "Yeni Türkan", lat: 40.37509, lng: 50.1767, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "zabrat_q", az: "Zabrat", ru: "Забрат", en: "Zabrat", lat: 40.48122, lng: 49.95258, type: "qesebe", kind: "area", parentId: "baku" },
  { id: "zeferan_q", az: "Zəfəran", ru: "Zəfəran", en: "Zəfəran", lat: 40.54272, lng: 50.05957, type: "qesebe", kind: "area", parentId: "baku" },
